            ...
            <div className="page--content">
                ...
                <div className="page--paragraph">
                    <Collapse title="Moving to stricter legislation" color="lightblue">
                        ...
                        <p>Brazil’s LGPD compels companies to adopt various security, technical, and administrative measures to protect personal data from unauthorized access and fines up to $12,300,000.</p>
                ...
                <div className="page--img-desc">
                    Degree of data regulation by country
                </div>
                <div className="page--subtitle">
                ...
                <div className="page--paragraph">
                    <Collapse title="Multinational abuses" color="lightblue">
                        <p>Although most cloud services such as Microsoft, Google, and Amazon, are based in the US, privacy shields in the US are significantly less than in the EU. </p>
                        <p>Therefore, concerns over these multinational companies may not be fully addressed. </p>
                    ...
                    <Collapse title="Change?" color="lightblue">
                        <p>However, Dr Edgar Whitely also pointed out that “some organisations are starting to realise that, despite the claimed benefits of big data and data analytics, data are actually a toxic resource that they are better off not holding on to.”</p>
                        <p>Therefore, this may suggest that such laws and regulations are somewhat starting to influence actions undertaken by organisations. </p>
                        <p>Additionally, during our group interview, he mentioned a specific example of an Austrian non-profit organization NOYB, chaired by data privacy activist Max Schrems, which filed complaints against Apple, Amazon, and eight other US tech firms on their failure to comply with the GDPR in regaining Europeans’ consent every time they wish to use their data in new ways, including for targeted advertising, and for transferring data of Europeans to the US for processing. </p>
                    </Collapse>
