    ...
    return (
        <>
            ...
            <div className="page--content">
                ...
                <div className="page--img-desc" style={{fontWeight: "normal", fontSize: "0.8rem"}}>
                    It is not recommended to attempt this activity on a mobile device.
                </div>
                ...
                <div className="page--paragraph">
                    ...
                    <br></br>
                    <Collapse title="The power of metadata" color="lightpink">
                    ...
                    <Collapse title="What does the expert think?" color="lightpink">
                        ...
                        <p>Dr Whitley pointed out, that:</p>
