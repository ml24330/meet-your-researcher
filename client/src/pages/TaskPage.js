...
const taskList = [
    ...
    {name: "Attending interviews", desc: "Many research areas, especially in the field of social sciences, require the behaviours and thoughts of people to be studied. Hence, researchers must interview people relevant to their study - for instance, Prof. Whitley is planning to interview organisations for his upcoming paper. Researchers also get interviewed about their work, as sometimes they would like the general public to be aware and understand their research. ", img: interview},
    {name: "Teaching a class", desc: "Researchers also teach classes related to their field of research at LSE. Prof. Whitley is currently not teaching any classes due to the pandemic, while some others still do. Prof. Whitley has teached information science related management courses, for example.", img: teach},
